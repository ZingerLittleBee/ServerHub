...
const logoUrl =
    'https://assets.serverbee.app/server-octopus/server-octopus-logo.png'

const supportEmail = 'support@serverbee.app'
...
export const VerifyIdentityEmail = ({
    ...
    <Html>
        ...
        <Body style={main}>
            ...
            <Text style={footer}>Securely powered by ServerBee.</Text>
        </Body>
    </Html>
)
